...
type StatsCalculator interface {
	...
	//
	//rankingHandler(w http.ResponseWriter, r *http.Request)
...
//			e._rank[id][category] = determineRanking(data, 0)
//		}
//	}
//	t4 := time.Now()
...
//}
//
//func determineRanking(m map[interface{}]int64, top int) siem.ItemList {
