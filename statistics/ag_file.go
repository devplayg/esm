...
//}
//
//func NewAgFileStats(engine *siem.Engine, router *mux.Router) *nsFileStats {
//	return &nsFileStats{
//		Stats: Stats{
//			name:   "ns_file",
//			Engine: engine,
...
//}
//
//func (s *agFileStats) Start() error {
//	go func() {
//		for {
...
//}
//
//func (s *agFileStats) calculate() error {
//	t1 := time.Now()
//	query := `
//		select 	t.rdate,
...
//}
//
//func (s *agFileStats) addToStats(r siem.DownloadLog, category string, val interface{}) error {
//
//	// By sensor
//	if r.SensorCode > 0 {
...
//}
//
//func (s *agFileStats) getRank(groupId int, category string, top int) siem.ItemList {
...
//}
//
//func (s *agFileStats) rankHandler(w http.ResponseWriter, r *http.Request) {
//	vars := mux.Vars(r)
//
